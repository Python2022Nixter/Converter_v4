...
def get_currency_code():
    ...
    while True:
        ...
        # print results
        # 0 - ('AL', 'Europe', 'Albania', 'EU', 'Tirana', 'ALL', '355', 'ALB')
        # 1 - ('AL', 'Europe', 'Albania', 'EU', 'Tirana', 'ALL', '355', 'ALB')
        # for next_row in cursor.fetchall():
        #     print (next_row)
        #     pass
        # check if database returned single result
